...
greeter = (name, age) => 'Hi, I\'m\ ' + name + ' and I am ' + age + ' years old.';
...
animalSounds = (name, sound, callback) => 'I am ' + wildNameReturn('Bryan') + ". Hear me meow.";
...
// CODE HERE
first = (arrOfNames, callback) => callback(arrOfNames[0]);
...
// CODE HERE
goodPeople.forEach((personObject) => personObject.family = true);